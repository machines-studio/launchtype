...
* __optimH__ ```Number```
* __optimW__ ```Number```
* __resolFactor__ ```Number``` (default Value: `0.5`)
...
* __x1__ ```Number``` (default Value: `0`)
* __x2__ ```Number``` (default Value: `0`)
* __y1__ ```Number``` (default Value: `0`)
* __y2__ ```Number``` (default Value: `0`)
